...
export const voteTypeMap = {
  [voteType.winLoss]: '全场独赢',
  [voteType.letBall]: '全场让球',
  [voteType.gameNumber]: '全场总局分数',
  [voteType.overGameLetBall]: '大局让分',
  [voteType.bureauLetBall]: '单局让分',
  [voteType.oddPurchase]: '倍率购买',
};

export const MATCH_LIST_TYPE = {
  TODAY: {
    id: 1,
    value: '今日',
  },
